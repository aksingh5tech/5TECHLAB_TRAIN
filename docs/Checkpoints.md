...
```bash
python scripts/convert_olmo_to_hf_new.py --input_dir /path/to/qxlabtrain/checkpoint --output_dir /path/to/hf/checkpoint/ --tokenizer_json_path tokenizers/allenai_gpt-neox-qxlabtrain-dolma-v1_5.json
```
