...
from weights_conversion.tokenization_qxlab_fast import OLMoTokenizerFast
...
Sample usage:
```
python src/transformers/models/qxlab/convert_olmo_weights_to_hf.py \
    --input_dir /path/to/downloaded/qxlab/weights --model_size 7B --output_dir /output/path
```
